...
-- AddForeignKey
ALTER TABLE `Favorite_Prouct` ADD CONSTRAINT `Favorite_Prouct_favorite_id_fkey` FOREIGN KEY (`favorite_id`) REFERENCES `Favorite`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `Favorite_Prouct` ADD CONSTRAINT `Favorite_Prouct_product_id_fkey` FOREIGN KEY (`product_id`) REFERENCES `Product`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
